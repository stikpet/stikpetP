...
def vi_dot_plot(data, dotSize = 1):
    ...
    Parameters
    ----------
    data : the data from which to create the dot plot, either a list or Pandas series
    dotSize : indicator for how big the dots need to be
    
    Returns
    -------
    plt : a pyplot with the dot plot
